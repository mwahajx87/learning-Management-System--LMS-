...
// Weekly Class Schedule (current week)
export const INITIAL_SCHEDULE_DAYS = [
...
// Attendance Summary (aggregate stats)
...
// Monthly Attendance Records (grouped by month)
...
// Fee / Voucher Records
export const INITIAL_FEE_RECORDS = [
  {
    id: 1,
    month: "Sep 2026",
    amount: "Rs: 1000 /-",
...
// Progress Modules & Topics
export const INITIAL_PROGRESS_MODULES = [
  {
    id: "mod-1",
    title: "Web Designing",
    topicsCompleted: 20,
...
export const INITIAL_ASSIGNMENTS = [
  ...
  },
  {
    ...
    status: "SUBMITTED",
    referenceLinks: ["https://developer.mozilla.org/en-US/docs/Web/JavaScript"],
    description:
