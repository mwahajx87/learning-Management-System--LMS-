    ...
    if (editingTeacherAssignment) {
      ...
      setEditTopics(
        Array.isArray(editingTeacherAssignment.topics)
          ? editingTeacherAssignment.topics.filter((t) => !t.startsWith('+')).join(', ')
          : ''
      );
          ...
          <div className="border bg-[#0d0f13] w-full max-w-lg rounded-2xl p-4 sm:p-6 shadow-2xl relative max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-xs">Publish assignment details directly to student dashboards</p>
              </div>
            </div>
            ...
            <form onSubmit={handleCreateAssignment} className="flex flex-col gap-4 text-xs">
              ...
              <div>
                <label className="block font-medium mb-1">Description & Instructions</label>
                <textarea
                  rows={3}
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <label htmlFor="is-hackathon-check" className="font-medium cursor-pointer">
      ...
      {editingTeacherAssignment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fadeIn">
          <div className="bg-[#0d0f13] border w-full max-w-lg rounded-2xl p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-xs mb-4">Modify assignment guidelines and due dates</p>
            ...
            <form onSubmit={handleSaveEdit} className="flex flex-col gap-4 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="edit-is-hackathon-check" className="font-medium cursor-pointer">
                  Hackathon Challenge
                </label>
              </div>
          ...
          <div className="bg-[#0d0f13] border w-full max-w-2xl rounded-2xl p-4 sm:p-6 shadow-2xl relative max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-5 text-xs">
              <div className="p-3 rounded-lg border">
                ...
                <div className="font-semibold mt-0.5">{selectedTeacherAssignment.dueDate}</div>
              </div>
              <div className="p-3 rounded-lg border">
            ...
            <div className="divide-y border rounded-xl overflow-hidden max-h-60 overflow-y-auto">
              {teacherStudents.slice(0, 10).map((st, idx) => (
                <div key={st.id} className="flex items-center justify-between p-3 text-xs transition-colors">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <span className="text-[11px] font-mono">({st.rollNumber})</span>
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in overflow-y-auto">
          <div className="border bg-[#0d0f13] w-full max-w-md rounded-2xl p-4 sm:p-6 shadow-2xl relative max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-3.5 mb-5">
              ...
              />
              <div>
                <h3 className="text-base font-bold">{selectedStudentForInspect.name}</h3>
                <div className="flex items-center gap-1.5 text-xs mt-0.5">
                  <span className="font-mono">{selectedStudentForInspect.rollNumber}</span>
                  <button
                    type="button"
                    onClick={() => copyToClipboard(selectedStudentForInspect.rollNumber, 'Roll Number')}
                   
                  >
                    <Copy className="w-3 h-3" />
                  </button>
                  <span>•</span>
                  <span className="font-semibold">{selectedStudentForInspect.status}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2.5 mb-4 text-xs">
              <div className="p-3 rounded-xl border">
                <div className="text-[10px] uppercase font-bold tracking-wider">Attendance Rate</div>
                <div className="text-xl font-bold mt-0.5">
                  {selectedStudentForInspect.attendanceRate || 92}%
                </div>
              </div>
              <div className="p-3 rounded-xl border">
                <div className="text-[10px] uppercase font-bold tracking-wider">Assignments Done</div>
                <div className="text-xl font-bold mt-0.5">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in overflow-y-auto">
          <div className="border bg-[#0d0f13] w-full max-w-lg rounded-2xl p-4 sm:p-6 shadow-2xl relative max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="p-3 rounded-xl border">
                <div className="font-semibold mb-1">
                  Q2: Which method is used to serialize a JavaScript object into a JSON string?
                </div>
                <div className="pl-2 border-l-2">
              ...
              <div className="p-3 rounded-xl border">
                <div className="font-semibold mb-1">
                  Q3: What is the primary difference between `null` and `undefined`?
                </div>
                <div className="pl-2 border-l-2">
                  Correct Answer: `null` is an assigned intentional empty value, while `undefined` represents a declared variable without an assigned value.
                </div>
              </div>
            </div>
      ...
      {isNewQuizOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in overflow-y-auto">
          <div className="border bg-[#0d0f13] w-full max-w-md rounded-2xl p-4 sm:p-6 shadow-2xl relative max-h-[90dvh] sm:max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-xs mb-4">Launch online assessment for students</p>

            <form onSubmit={handleCreateQuiz} className="flex flex-col gap-3.5 text-xs">
              <div>
